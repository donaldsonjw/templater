...
(define (main args)
   (let* ((templater (make-templater :load-path "/home/jwd/srcs/fastcgi"))
	 (template (templater-get-template templater "test")))
      (print (templater-apply-template templater template
				       '(("name" . Joe)
					 ("stuff" . ("sheryl" "libraries")))))))